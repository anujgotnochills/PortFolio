  ...
  const testimonials = [
    {
      ...
      screenshot: "/testimonials/client1-chat.png" // WhatsApp chat screenshot
    },
    {
      name: "Avinash Kumar",
      role: "Business Owner",
    ...
    // Uncomment below when you have more testimonial screenshots
    // {
    //   name: "Client",
    //   role: "YouTuber",
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row gap-0">
                ...
                <div className="relative w-full md:w-[250px] lg:w-[280px] flex-shrink-0">
                  <div className="aspect-[9/16] bg-muted max-h-[450px] md:max-h-[500px] mx-auto">
                    <img
                ...
                <div className="p-6 md:p-8 flex flex-col justify-center flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-primary mb-4">Client FeedBack</h3>
